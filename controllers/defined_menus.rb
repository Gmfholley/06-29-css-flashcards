module DefinedMenus
  ...
  def home_menu
    ...
    m.add_menu_item(user_message: ["Work with css database."], method_name: "css_definition")
    m.add_menu_item(user_message: ["Play a multiple-choice game of css definitions."], method_name: "css_definition/multi_choice")
    m
  end
