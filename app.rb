...
require_relative 'models/css_defs.rb'
...
require_relative 'controllers/flash_card.rb'
...
helpers DefinedMenus, MenuController, CreateController, ERBVariableMethods, GameMethods
...
get "/:class_name/:action" do
  ...
  when "multi_choice"
    g = FlashCardGame.new(@class_name)
    @question = g.create_question_from_object
